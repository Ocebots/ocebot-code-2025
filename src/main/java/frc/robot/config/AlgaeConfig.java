...
public class AlgaeConfig {
  ...
  public static final Rotation2d PICKUP_ANGLE = Rotation2d.fromRadians(-1.20);
  public static final Rotation2d STORE_ANGLE = Rotation2d.fromRadians(-0.70);
  public static final Rotation2d IDLE_ANGLE = Rotation2d.fromDegrees(-0.30);
